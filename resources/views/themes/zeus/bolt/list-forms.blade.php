        ...
        @foreach($categories as $category)
            <x-filament::section>
                ...
                @foreach($category->forms as $form)
                    <a href="{{ route('forms.show', ['slug' => $form->slug]) }}" class="flex flex-col py-2 px-1.5 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-md transition ease-in-out duration-500 block cursor-pointer">
